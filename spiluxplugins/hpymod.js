...
zokou(
  ...
  async (dest, zk, commandeOptions) => {
    ...
    try {
      ...
      await repondre(`𝐒𝐏𝐈𝐋𝐔𝐗-𝐌𝐃\n\n◈━━━━━━━━━━━━━━━━◈\n│❒ Yo ${nomAuteurMessage}, 𝔖𝔭𝔦𝔩𝔲𝔵-𝔐𝔇’s hunting for "${query}" on HappyMod! 📱 Hold tight! 🔍\n◈━━━━━━━━━━━━━━━━◈`);
      ...
      if (!data.success || !data.results?.data?.length) {
        return repondre(`𝐒𝐏𝐈𝐋𝐔𝐗-𝐌𝐃\n\n◈━━━━━━━━━━━━━━━━◈\n│❒ Yo ${nomAuteurMessage}, 𝔖𝔭𝔦𝔩𝔲𝔵-𝔐𝔇 found zilch for "${query}" on HappyMod! 😕 Try another search term! 🤔\n◈━━━━━━━━━━━━━━━━◈`);
      }
...
◈━━━━━━━━━━━━━━━━◈
│❒ Yo ${nomAuteurMessage}, 𝔖𝔭𝔦𝔩𝔲𝔵-𝔐𝔇 snagged some HappyMod apps for "${query}"! 📱🔥
${resultText}
...
◈━━━━━━━━━━━━━━━━◈
      ...
      await repondre(`𝐒𝐏𝐈𝐋𝐔𝐗-𝐌𝐃\n\n◈━━━━━━━━━━━━━━━━◈\n│❒ TOTAL BUST, ${nomAuteurMessage}! 𝔖𝔭𝔦𝔩𝔲𝔵-𝔐𝔇 tripped while searching HappyMod: ${error.message} 😡 Try again or flop! 😣\n◈━━━━━━━━━━━━━━━━◈`);
    }
  }
);