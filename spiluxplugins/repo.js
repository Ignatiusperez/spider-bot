...
◈━━━━━━━━━━━━━━━━◈
│❒ Yo ${nomAuteurMessage}, here’s the 411 on 𝔖𝔭𝔦𝔩𝔲𝔵-𝔐𝔇’s repo! 📦
│❒ *🔗 𝐆𝐢𝐭𝐇𝐮𝐛*: https://github.com/spider660/Spilux-MD/fork
│❒ *📩 𝐖𝐡𝐚𝐭𝐬𝐀𝐩𝐩 𝐆𝐫𝐨𝐮𝐩*: https://chat.whatsapp.com/GoXKLVJgTAAC3556FXkfFI
│❒ *💾 𝐑𝐀𝐌 𝐔𝐬𝐚𝐠𝐞*: ${format(os.totalmem() - os.freemem())} / ${format(os.totalmem())}
│❒ *👑 𝐃𝐞𝐯𝐞𝐥𝐨𝐩𝐞𝐫*: 𝐬𝐩𝐢𝐥𝐮𝐱_𝐥𝐚𝐮
│❒ *🌐 𝐌𝐨𝐝𝐞*: ${mode}
│❒ *📅 𝐃𝐚𝐭𝐞*: ${date}
│❒ *⏰ 𝐓𝐢𝐦𝐞 (GMT)*: ${time}
...
◈━━━━━━━━━━━━━━━━◈
      ...
      if (lien.match(/\.(mp4|gif)$/i)) {
        try {
          ...
          await repondre(`𝐒𝐏𝐈𝐋𝐔𝐗-𝐌𝐃\n\n◈━━━━━━━━━━━━━━━━◈\n│❒ Yo ${nomAuteurMessage}, 𝔖𝔭𝔦𝔩𝔲𝔵-𝔐𝔇 fumbled the video send: ${e.message} 😡 Here’s the repo info anyway! 😣\n${infoMsg}\n◈━━━━━━━━━━━━━━━━◈`);
        }
      }
      // Send the message with an image if the URL is an image (jpeg, png, jpg)
        ...
        try {
          ...
          await repondre(`𝐒𝐏𝐈𝐋𝐔𝐗-𝐌𝐃\n\n◈━━━━━━━━━━━━━━━━◈\n│❒ Yo ${nomAuteurMessage}, 𝔖𝔭𝔦𝔩𝔲𝔵-𝔐𝔇 botched the image send: ${e.message} 😡 Here’s the repo info anyway! 😣\n${infoMsg}\n◈━━━━━━━━━━━━━━━━◈`);
        }
      }
      ...
      await repondre(`ѕριℓυχ-м∂\n\n◈━━━━━━━━━━━━━━━━◈\n│❒ TOTAL BUST, ${nomAuteurMessage}! 𝔖𝔭𝔦𝔩𝔲𝔵-𝔐𝔇 crashed while fetching repo info: ${e.message} 😡 Try again or flop! 😣\n◈━━━━━━━━━━━━━━━━◈`);
    }
  }
);